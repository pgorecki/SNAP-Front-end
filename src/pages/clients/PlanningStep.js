...
import { Button, Grid, Checkbox, Dropdown, Menu, Segment } from 'semantic-ui-react';
...
const modifyiep = [
 ( <Segment>
   ...
   <Button style={{ marginTop: "1rem" }}>Ok</Button>
       ...
       <h4>No programs are planned yet.Please modify IEP plan </h4>
          <Grid>       
              ...
              <Button style={{marginLeft: "1rem" }}>Assess Client</Button>
                <Dropdown options={modifyiep} button text="Modify IEP plan">
